...
COMMAND.Run = function(pl, args, supp)
    ...
    if (not moat.isdev(pl) and (tmname == "director" or tmname == "communitymanager" or tmname == "servermanager" or tmname == "headadmin")) then
    ...
    D3A.LoadSteamID(sid, function(d)
        ...
        D3A.Chat.Broadcast2(pl, moat_cyan, plname, moat_white, " has set the rank of ", moat_green, d.name, moat_white, " (", moat_green, util.SteamIDFrom64(sid), moat_white, ") to ", moat_green, tmname, moat_white, ".")
