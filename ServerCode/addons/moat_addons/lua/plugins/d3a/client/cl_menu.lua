...
MGA.CommandList = {
	...
	{80, "Head Administrator", Color(51, 0, 51, 255), {
		...
		{"TradeUnban", "Removes a players trade ban", true, {
			{"Entry", "SteamID", "STEAM_0:0"}
		}},
	}},
	{90, "Management", Color(255, 0, 0, 255), {
...
function mga.Main.Open()
	...
	mga.bg = ux.Create("DFrame", function(s)
		...
		draw.WebImage("https://cdn.notfound.tech/ZbiTBZ.png", 0, 0, 2048, 2048, Color(255, 255, 255, 250))
		*/
