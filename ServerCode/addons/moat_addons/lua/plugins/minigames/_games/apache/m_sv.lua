...
local death_voices = {
	"https://tera.gg/ttt/misc/tttsounds/apache/apache_death1smith.mp3",
	"https://tera.gg/ttt/misc/tttsounds/apache/apache_death2smith.mp3",
	"https://tera.gg/ttt/misc/tttsounds/apache/apache_death3smith.mp3",
	"https://tera.gg/ttt/misc/tttsounds/apache/apache_death4smith.mp3",
	"https://tera.gg/ttt/misc/tttsounds/apache/apache_death5smith.mp3",
	"https://tera.gg/ttt/misc/tttsounds/apache/apache_death6smith.mp3",
	"https://tera.gg/ttt/misc/tttsounds/apache/apache_death7smith.mp3",
	"https://tera.gg/ttt/misc/tttsounds/apache/apache_death8smith.mp3",
	"https://tera.gg/ttt/misc/tttsounds/apache/apache_death9smith.mp3",
	"https://tera.gg/ttt/misc/tttsounds/apache/apache_death10smith.mp3",
	"https://tera.gg/ttt/misc/tttsounds/apache/apache_death11smith.mp3",
}
local boss_voices = {
	"https://tera.gg/ttt/misc/tttsounds/apache/apache2smith.mp3",
	"https://tera.gg/ttt/misc/tttsounds/apache/apache3smith.mp3",
	"https://tera.gg/ttt/misc/tttsounds/apache/apache4smith.mp3",
	"https://tera.gg/ttt/misc/tttsounds/apache/apache5smith.mp3",
	"https://tera.gg/ttt/misc/tttsounds/apache/apache6smith.mp3",
	"https://tera.gg/ttt/misc/tttsounds/apache/apache7smith.mp3",
	"https://tera.gg/ttt/misc/tttsounds/apache/apache8smith.mp3",
	"https://tera.gg/ttt/misc/tttsounds/apache/apache9smith.mp3",
}
...
function moat_InitializeApacheBoss(ply)
    ...
    local boss_hp = 6000 * player.GetCount()
...
local function moat_BossPlayerDeath(ply)
    ...
    if (not IS_BOSS) then
		cdn.PlayURL("https://tera.gg/ttt/misc/tttsounds/apache/apache_loss_smith.mp3", 2)
		if (IsValid(MOAT_BOSS_CUR_PLY)) then
            MOAT_BOSS_CUR_PLY:m_DropInventoryItem(math.random(5,6))
        end
        return
    else
		cdn.PlayURL("https://tera.gg/ttt/misc/tttsounds/apache/apache_won_smith.mp3", 2)
    end
...
local function moat_BeginRoundBossHooks()
    ...
    hook.Add("ttt.BeginRound", "moat_BossBeginRound", function()
        ...
        timer.Simple(1, function()
            MuteForRestart(true)
			cdn.PlayURL(table.Random({"https://tera.gg/ttt/misc/tttsounds/apache/apache_america1smith.mp3", "https://tera.gg/ttt/misc/tttsounds/apache/apache_america2smith.mp3"}), 2)
        end)
