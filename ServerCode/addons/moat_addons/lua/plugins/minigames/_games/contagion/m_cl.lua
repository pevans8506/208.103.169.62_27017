...
function MG_CG.PrepRound()
	...
	cdn.PlayURL("https://tera.gg/ttt/misc/tttsounds/virus/prepare.mp3")
...
function MG_CG.InfectedChams()
    ...
    cam.Start3D()
		for k, v in ipairs(MG_CG.InfectedPlayers) do
			if (not IsValid(v) or not v:IsPlayer() or v:Team() == TEAM_SPEC) then continue end
...
local music_urls = {
	"https://tera.gg/ttt/misc/tttsounds/virus/song1.mp3",
	"https://tera.gg/ttt/misc/tttsounds/virus/song2.mp3",
	"https://tera.gg/ttt/misc/tttsounds/virus/song3.mp3",
	"https://tera.gg/ttt/misc/tttsounds/virus/song4.mp3"
}
local music_nums = {
    288,
    256,
