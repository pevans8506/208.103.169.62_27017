...
net.Receive("PH_Begin",function()
    ...
    MOAT_PH = {
        ...
        TopKills = 0,
        MyKills = 0,
        time_end = CurTime() + (player.GetCount() * 13) + 30,
	...
	cdn.PlayURL("https://tera.gg/ttt/minigames/time.mp3", 0.8, function(station)
...
hook.Add("HUDPaint", "moat.test.LPH", function()
    ...
    cdn.DrawImage("https://tera.gg/ttt/misc/clock.png", (w/2) - (32), 0, 64, 64, Color(255, 255, 255, 225))
    ...
    cdn.DrawImage("https://tera.gg/ttt/misc/bomb.png", (w/2) - (32), h - txh - 124, 64, 64, Color(255, 255, 255, 225))*/
end)
...
net.Receive("PH_Prep",function()
    cdn.PlayURL("https://tera.gg/ttt/misc/tttsounds/boss_warning.mp3")
