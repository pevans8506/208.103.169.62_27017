...
net.Receive("lava_Begin",function()
	LavaTexture = cdn.Image("https://tera.gg/ttt/minigames/lava.jpg", function(img) LavaTexture = img end, "noclamp")
	...
	cdn.PlayURL("https://tera.gg/ttt/minigames/tdm_song.mp3", 0.5, function(station)
...
hook.Add("PostDrawTranslucentRenderables", "DrawLava", function(a, b)
	...
	render.Clip(ClipTab, function()
		if (not LavaTexture) then
			LavaTexture = cdn.Image("https://tera.gg/ttt/minigames/lava.jpg", function(img)
				LavaTexture = img
			end, "noclamp")
			return
		end
