...
net.Receive("TNT_Begin",function()
    ...
    MOAT_TNT = {
        ...
        TopKills = 0,
        MyKills = 0,
        time_end = CurTime() + (player.GetCount() * 15) + 30,
...
hook.Add("HUDPaint", "moat.test.LTNT", function()
    ...
    cdn.DrawImage("https://tera.gg/ttt/misc/bomb.png", (w/2) - (32), h - txh - 124, 64, 64)
    cdn.DrawImage("https://tera.gg/ttt/misc/clock.png", (w/2) - (32), 0, 64, 64)
end)
