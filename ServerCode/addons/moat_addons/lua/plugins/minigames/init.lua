...
MOAT_MINIGAMES.Print = function(s)
	MsgC(Color(0, 0, 0), "[", Color(255, 0, 0), "Tera Minigames", Color(0, 0, 0), "]", Color(0, 255, 255), s, "\n" )
end
...
MOAT_MINIGAMES.AddMinigame("Headless Horseman Round", 
    "hh",
    "moat_start_hh", 
    500, 
    "Work with your teammates to win the round or take down the Horseman!"
)
...
--s
	net.Receive("Minigame Chat", function(len)
		...
		chat.AddText(Material("icon16/information.png"), Color(0, 0, 0), "[", Color(255, 0, 0), "Tera Minigames", Color(0, 0, 0), "]", Color(0, 255, 255), str)
	end)
