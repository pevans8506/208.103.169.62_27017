...
local group_images = {
    ["director"] = "icon16/application_xp_terminal.png",
    ["communitymanager"] = "icon16/rainbow.png",
    ["servermanager"] = "icon16/palette.png",
...
net.Receive("RAM_MapVoteUpdate", function()
    ...
    if (update_type == MapVote.UPDATE_VOTE) then
        ...
        if (IsValid(ply)) then
            ...
            chat.AddText(moat_blue, "| ", moat_cyan, ply:Nick(), moat_white, " placed ", am == 1 and moat_green or moat_pink, tostring(am), moat_white, " vote" .. (am == 1 and "" or "s") .. " on ", moat_green, MapVote.CurrentMaps[map_id], moat_white, ".")
...
function MapVote.Show()
    ...
    function like:Paint(w, h)
        cdn.DrawImage("https://tera.gg/ttt/misc/fb_up.png", 0, 0, w, h, Color(0, 255, 0, 50))
    end
    ...
    function like:Paint(w, h)
        cdn.DrawImageRotated("https://tera.gg/ttt/misc/fb_down.png", 0, 0, w, h, Color(255, 0, 0, 50), 180, 50)
    end
    ...
    for i = 1, 8 do
        ...
        a:Dock(LEFT)
        local url = "https://tera.gg/ttt/misc/md_map2.png"
        a:SetText("")
        local ispic = false
        ...
        http.Fetch("https://image.gametracker.com/images/maps/160x120/garrysmod/" .. map .. ".jpg", function(_, _, _, c)
            if not tostring(c):match("^2") then
                url = "https://tera.gg/ttt/misc/md_map2.png"
            else
        ...
        function a:Paint(w, h)
            ...
            if (url == "https://tera.gg/ttt/misc/md_map2.png") then
            ...
            --[[if (MapVote.Feedback[map] and MapVote.Feedback[map].Positive and MapVote.Feedback[map].Negative) then
				...
				m_DrawShadowedText(1,string.Friendly(MapVote.Feedback[map].Negative), "moat_Feedback", (w/2)+35, 148 + 9, (MapVote.Panel.Winner == i and HSVToColor((SysTime()*100)%360,0.65,0.9)) or Color(255,255,255, 255), TEXT_ALIGN_LEFT)
        			cdn.DrawImage("https://tera.gg/ttt/misc/fb_up.png",10,148 + 9,20,20,Color(255,255,255,25))
				cdn.DrawImageRotated("https://tera.gg/ttt/misc/fb_down.png",(w/2)+10,148 + 9,20,20,Color(255,255,255,25),180,50)
            else
...
concommand.Add("mpsh", function()
    MapVote.CurrentMaps = {"ttt_minecraft_b5", "ttt_67thway_v14", "ttt_terraria", "ttt_minecraftcity_v4", "ttt_clue_se", "ttt_experimental_shapes", "ttt_minecraft_haven", "ttt_waterworld"}
    ...
    for i = 1, 8 do
        ...
        MapVote.Feedback[MapVote.CurrentMaps[i]] = {
            Positive = pos,
            Negative = neg,
            Count = pos + neg
        }
