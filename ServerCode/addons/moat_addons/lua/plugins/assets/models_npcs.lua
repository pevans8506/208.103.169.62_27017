...
player_manager.AddValidModel("Solaire of Astora", "models/player_solaire.mdl")
player_manager.AddValidHands("Solaire of Astora", "models/solaire_arms.mdl", 0, "00000000")
player_manager.AddValidModel("[K] Deadpool", "models/kryptonite/deadpool/deadpool.mdl")
list.Set("PlayerOptionsModel", "[K] Deadpool", "models/kryptonite/deadpool/deadpool.mdl")
player_manager.AddValidModel("Link (Hyrule Warriors)", "models/player/pyroteknik/link_hw.mdl")
player_manager.AddValidModel("Clone Assassin", "models/tera_gg/assassin/trooper/assassin.mdl")
player_manager.AddValidModel("501st Rex", "models/tera_gg/loudmantis/501/rex.mdl")
local Category = "Halo 3 Elites"
...
player_manager.AddValidHands("halo3elite", "Models/Viewmodels/halo3elitehands.mdl", 0, "00000000")
AddPlayerModel("patrol_04", "models/portal2/patrol_04.mdl", "models/weapons/c_arms_dod.mdl")
player_manager.AddValidModel("RoboCop", "models/bigsmoke/smoke.mdl")
list.Set("PlayerOptionsModel", "RoboCop", "models/bigsmoke/smoke.mdl")
...
player_manager.AddValidModel("CarlWheezer", "models/carlwheezer/Playermodels/carlwheezer.mdl")
list.Set("PlayerOptionsModel", "CarlWheezer", "models/carlwheezer/Playermodels/carlwheezer.mdl")
