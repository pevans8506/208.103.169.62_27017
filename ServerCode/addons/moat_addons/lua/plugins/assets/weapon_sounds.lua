...
local TFA = TFA or {}
local CustomizableWeaponry = CustomizableWeaponry or {}
...
function CustomizableWeaponry:findFireSound(snd)
    ...
    if self.registeredSoundNames[snd] then return self.registeredSoundNames[snd] end
    -- welp
...
sound.Add({
    ...
    channel = CHAN_VOICE,
    volume = 1.0,
    sound = {"weapons/predator_blade/taunt-1.wav", "weapons/predator_blade/taunt-2.wav"}
})
...
sound.Add({
    ...
    channel = CHAN_VOICE,
    volume = 1.0,
    sound = {"weapons/predator_blade/hit-1.wav", "weapons/predator_blade/hit-2.wav", "weapons/predator_blade/hit-3.wav", "weapons/predator_blade/hit-4.wav"}
})
...
sound.Add({
    ...
    channel = CHAN_VOICE,
    volume = 1.0,
    sound = {"weapons/predator_blade/slash-1.wav", "weapons/predator_blade/slash-2.wav"}
})
...
-- H&K G11 K2
sound.Add({
    name = "Weapon_G11.Clipout",
    channel = CHAN_ITEM,
    volume = 1.0,
    sound = "weapons/hk_g11/clipout.wav"
})

sound.Add({
    name = "Weapon_G11.Clipin",
    channel = CHAN_ITEM,
    volume = 1.0,
    sound = "weapons/hk_g11/clipin.wav"
})

sound.Add({
    name = "Weapon_G11.Draw",
    channel = CHAN_ITEM,
    volume = 1.0,
    sound = "weapons/hk_g11/draw.wav"
})

sound.Add({
    name = "Weapon_G111.Tap",
    channel = CHAN_ITEM,
    volume = 1.0,
    sound = "weapons/hk_g11/tap.wav"
})
...
instbl["CompatibilityAttenuation"] = "1"
instbl["pitch"] = "95,105"
instbl["sound"] = "weapons/tfa_csgo/tec9/tec9_clipin.wav"
...
instbl["CompatibilityAttenuation"] = "1"
instbl["pitch"] = "95,105"
instbl["sound"] = "weapons/tfa_csgo/tec9/tec9_clipout.wav"
...
instbl["CompatibilityAttenuation"] = "1"
instbl["pitch"] = "95,105"
instbl["sound"] = "weapons/tfa_csgo/tec9/tec9_boltpull.wav"
...
instbl["CompatibilityAttenuation"] = "1"
instbl["pitch"] = "95,105"
instbl["sound"] = "weapons/tfa_csgo/tec9/tec9_boltrelease.wav"
...
instbl["CompatibilityAttenuation"] = "1"
instbl["pitch"] = "95,105"
instbl["sound"] = "weapons/tfa_csgo/tec9/tec9_draw.wav"
...
instbl["pitch"] = "95,105"
instbl["sound"] = "weapons/tfa_csgo/tec9/tec9-1.wav"
...
sound.Add({
    ...
    volume = 1.0,
    soundlevel = 80,
    sound = "weapons/hbg/gunother/hbg_clipout.wav"
})
...
sound.Add({
    ...
    volume = 1.0,
    soundlevel = 80,
    sound = "weapons/hbg/gunother/hbg_clipin.wav"
})
...
sound.Add({
    ...
    volume = 1.0,
    soundlevel = 80,
    sound = "weapons/hbg/gunother/hbg_slideback.wav"
})
-- PPSH-41
local SoundChars = {
...
TFA.AddFireSound("Weapon_BO2_RNMA.fire", {"weapons/nma/wpn_rnma_fire.wav"}, true, ")")

TFA.AddWeaponSound("Weapon_BO2_RNMA.Hammer", "weapons/nma/hammer.wav")
TFA.AddWeaponSound("Weapon_BO2_RNMA.Stock", "weapons/nma/stock.wav")
TFA.AddWeaponSound("Weapon_BO2_RNMA.Clipout", "weapons/nma/clipout.wav")
TFA.AddWeaponSound("Weapon_BO2_RNMA.Clipin", "weapons/nma/fly_mp5_pull_charge.wav")
TFA.AddWeaponSound("Weapon_BO2_RNMA.End", "weapons/nma/end.wav")
TFA.AddWeaponSound("Weapon_BO2_RNMA.Deploy", "weapons/nma/draw.wav")

-- decay
TFA.AddFireSound("Weapon_BO2_RNMA.TailOutside", {"weapons/nma/wpn_decay.wav"}, true, ")")

TFA.AddFireSound("Weapon_BO2_RNMA.TailInside", {"weapons/nma/wpn_rifle_decay_int.wav"}, true, ")")

-- DP28
CustomizableWeaponry:addFireSound("ZZ_MG24_FIRE", "weapons/zz_mg24/fire.wav", 1, 115, CHAN_STATIC)
CustomizableWeaponry:addReloadSound("ZZ_MG24_WPNUP", "weapons/zz_mg24/wpnup.wav")
CustomizableWeaponry:addReloadSound("ZZ_MG24_CLIPOUT", "weapons/zz_mg24/clipout.wav")
CustomizableWeaponry:addReloadSound("ZZ_MG24_CLIPIN", "weapons/zz_mg24/clipin.wav")
CustomizableWeaponry:addReloadSound("ZZ_MG24_PUNCH", "weapons/zz_mg24/punch.wav")
CustomizableWeaponry:addReloadSound("ZZ_MG24_TEST1", "weapons/zz_mg24/test1_1.wav")
CustomizableWeaponry:addReloadSound("ZZ_MG24_BOLTBK", "weapons/zz_mg24/boltbk.wav")
CustomizableWeaponry:addReloadSound("ZZ_MG24_BOLTFWD", "weapons/zz_mg24/boltfwd.wav")

-- AS VAL
sound.Add({
    name = "Weapon_AKs74u.Draw",
    channel = CHAN_USER_BASE + 10,
    volume = 1.0,
    sound = "weapons/Mosh&Naajzzz AS-VAL/deploy.wav"
})
...
sound.Add({
    ...
    channel = CHAN_ITEM,
    volume = 1.0,
    sound = "weapons/Mosh&Naajzzz AS-VAL/rof.wav"
})
...
sound.Add({
    ...
    channel = CHAN_ITEM,
    volume = 1.0,
    sound = "weapons/Mosh&Naajzzz AS-VAL/boltback.wav"
})
...
sound.Add({
    ...
    channel = CHAN_USER_BASE + 11,
    volume = 1.0,
    sound = "weapons/Mosh&Naajzzz AS-VAL/boltrelease.wav"
})
...
sound.Add({
    ...
    volume = 1.0,
    sound = "weapons/Mosh&Naajzzz AS-VAL/magout.wav"
})
...
sound.Add({
    ...
    volume = 1.0,
    sound = "weapons/Mosh&Naajzzz AS-VAL/magin.wav"
})

-- Terra Blade
sound.Add({
    name = "Terraslash",
    sound = {"terraslash.wav"},
    channel = CHAN_VOICE,
})
...
sound.Add(
{
    name = "shooting_sshotty",
    channel = CHAN_STATIC,
    volume = 1.0,
    soundlevel = 80,
    sound = "weapons/tfa_doom/ssg/wpn_shotgun_dbl_fire_02.wav"
}
)
...
sound.Add(
{
    ...
    volume = 1.0,
    soundlevel = 80,
    sound = "weapons/tfa_doom/ssg/sfx_wpn_supershotgun_shell_insert_deep_02.wav"
}
)

sound.Add(
{
    name = "reload_sshotty1",
    channel = CHAN_STATIC,
    volume = 1.0,
    soundlevel = 80,
    sound = "weapons/tfa_doom/ssg/wpn_shotgun_dbl_reload_open_02.wav"
}
)

sound.Add(
{
    name = "reload_sshotty2",
    channel = CHAN_STATIC,
    volume = 1.0,
    soundlevel = 80,
    sound = "weapons/tfa_doom/ssg/wpn_shotgun_dbl_reload_close_01.wav"
}
)

TFA.AddWeaponSound("weapon_bo3_ppsh.magout", "weapons/bo3/ppsh/fly_ppsh_mag_out.wav")
TFA.AddWeaponSound("weapon_bo3_ppsh.magin", "weapons/bo3/ppsh/fly_ppsh_mag_in.wav")
TFA.AddWeaponSound("weapon_bo3_ppsh.chargeback", "weapons/bo3/ppsh/fly_ppsh_bolt_forward.wav")

TFA.AddFireSound("weapon_bo3_ppsh.fire", {"weapons/bo3/ppsh/wpn_smg_ppsh_start.wav"}, true, ")")
