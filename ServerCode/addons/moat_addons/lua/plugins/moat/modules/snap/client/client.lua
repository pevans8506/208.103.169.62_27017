snapper.cache = {}
local tera_snap_prefix = {Material("icon16/information.png"), Color(0, 0, 0), "[", Color(255, 0, 0), "Tera Snap 3.0", Color(0, 0, 0), "] ", Color(255, 255, 255)}
...
net.Receive("Snapper Capture", function(length, server)
    ...
    chat.AddText(Material("icon16/information.png"), Color(0, 0, 0), "[", Color(255, 0, 0), "Tera Snap 3.0", Color(0, 0, 0), "] ", Color(255, 255, 255), "Breaking into their game...")
...
net.ReceiveChunk("Snapper Send", function(data, server)
	...
	file.Write("tera_snap/snaps/" .. (snapper.victim:SteamID64() .. "_") .. os.time() .. ".png", dec)

    chat.AddText(Material("icon16/information.png"), Color(0, 0, 0), "[", Color(255, 0, 0), "Tera Snap 3.0", Color(0, 0, 0), "] ", Color(255, 255, 255), "Reading their pixels...")
...
net.Receive("Snapper Status", function(len, server)
    ...
    chat.AddText(Material("icon16/information.png"), Color(0, 0, 0), "[", Color(255, 0, 0), "Tera Snap 3.0", Color(0, 0, 0), "] ", Color(255, 255, 255), "Sending their pixels to you... " .. math.Round(p) .. "%")
