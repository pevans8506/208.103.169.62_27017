...
local sounds = {
    hit = {"https://cdn.notfound.tech/paintball1.mp3", "https://cdn.notfound.tech/paintball2.mp3", "https://cdn.notfound.tech/paintball3.mp3",},
    hityou = {"https://cdn.notfound.tech/paintballhit.mp3",}
}
...
local mats = {Material("cable/redlaser"), Material("cable/hydra"), Material("cable/physbeam"), Material("cable/xbeam")}
...
function EFFECT:Init(data)
    ...
    self.Material = mats[math.random(#mats)]
...
if (CLIENT) then
    decals = {Material(util.DecalMaterial"PaintSplatGreen"), Material(util.DecalMaterial"PaintSplatPink"), Material(util.DecalMaterial"PaintSplatBlue")}
end
