...
net.Receive("BP.Chat", function()
    ...
    if b then
        ...
        chat.AddText(mat, Color(255, 255, 255), "[Spring ", Color(0, 255, 255), "Climb", Color(255, 255, 255), "] You just unlocked tier ", Color(255, 0, 0), tostring(tier), Color(255, 255, 255), " and earned ", rarity_names[MOAT_BP.tiers[tier].rarity][2]:Copy(), MOAT_BP.tiers[tier].name, Color(255, 255, 255), "!")
    else
        chat.AddText(mat2, Color(255, 255, 255), "[Spring ", Color(0, 255, 255), "Climb", Color(255, 255, 255), "] You've gained XP towards your next Halloween Climb tier! (", Color(0, 255, 255), tostring(net.ReadInt(32)), Color(255, 255, 255), "/", tostring(xp_needed(tier + 1)), ")!")
    end
end)
...
function make_about()
    ...
    BP_ABOUT.Paint = function(s, w, h)
        local txtw = draw.SimpleText("Welcome to the Halloween Climb!", "moat_NotifyTest2", w / 2, 5, Color(255, 255, 255), TEXT_ALIGN_CENTER)
    ...
    lbl:SetPos(10, 145)
    lbl:SetText("Welcome to the Halloween Climb! Here, for a limited time you will be able to earn XP and level up your Halloween Climb to earn free rewards! Please keep in mind that any of the guns that you preview in the Halloween Climb are just that, a preview, and the gun that you earn will be random and unique! <3\n\nSome quick info:\n- Earned XP towards the Halloween Climb is not affected by Quadra XP (This might change)\n- Experience lovers (weapon XP) do not count towards the Halloween Climb\n- XP from Dailies do count towards the Halloween Climb\n- Dailies give half of their XP as rewards towards the Halloween Climb\n\nPlease remember to be nice to other players and to not meta game for the Halloween Climb rewards!\n- TERA TTT Staff Team <3\n\nEnjoy the event! (To get started, press 'Halloween Climb' in the tab above)")
...
function make_battlepass()
    ...
    M_BP.Paint = function(s, w, h)
        ...
        draw.DrawText('Halloween Climb', "moat_JackBig", w / 3, 15, Color(0, 255, 0), TEXT_ALIGN_CENTER)
        ...
        draw.SimpleTextOutlined("Kick back this October with Free XP and Rewards", "moat_GambleTitle", w / 3, 80, Color(0, 198, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 2, Color(0, 0, 0, 35))
...
function m_CreateBattlePanel(pnl_x, pnl_y, pnl_w, pnl_h)
    ...
    M_BATTLE_PNL.Paint = function(s, w, h)
        ...
        surface.DrawTexturedRect(0, 0, w, 45)
        draw.SimpleText("Tera", "moat_GambleTitle", 5, 1, Color(0, 25, 50))
        draw.SimpleText("TTT", "moat_GambleTitle", 45, 1, Color(50, 50, 50))
        draw.SimpleText("Tera", "moat_GambleTitle", 4, 0, Color(0, 198, 255))
        draw.SimpleText("TTT", "moat_GambleTitle", 45, 0, Color(255, 255, 255))
        draw.SimpleText("Halloween Climb", "moat_GambleTitle", 6, 21, Color(50, 50, 0))
        draw.SimpleText("Halloween Climb", "moat_GambleTitle", 5, 20, HSVToColor((CurTime() * 10) % 360, 1, 1))
    ...
    local MOAT_BP_CATS = {
        {"Halloween Climb", Color(255, 0, 50)},
