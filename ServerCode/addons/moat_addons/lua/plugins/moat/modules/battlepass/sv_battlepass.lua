...
function generate_bpexample(itemid, ply)
    ...
    if (item_to_drop.Kind == "tier" or item_to_drop.Kind == "Unique") then
        ...
        if (item_to_drop.Collection == "Retro Collection" or item_to_drop.Collection == "Summer Event Collection" or item_to_drop.Collection == "Omega Collection" or item_to_drop.Collection == "Flower Collection" or item_to_drop.Collection == "Valentine Collection" or item_to_drop.Collection == "Pumpkin Collection" or item_to_drop.Collection == "Omega Collection" or item_to_drop.Collection == "Holiday Collection" or item_to_drop.Collection == "New Years Collection") then
...
function bp_sql()
    ...
    local custom_rewards = {
        ...
        [-8] = function(ply)
                local crates = {"Goodie Bag #1", "Goodie Bag #2", "Goodie Bag #2", "Goodie Bag #2", "Goodie Bag #3"}
                ply:m_DropInventoryItem(crates[math.random(#crates)], "hide_chat_obtained", false, false)
        end,
        [-9] = function(ply)
