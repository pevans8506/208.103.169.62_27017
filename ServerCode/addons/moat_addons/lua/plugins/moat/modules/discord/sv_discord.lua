...
moat.discord = {}
moat.discord.clientID = "139152491496472576"
moat.discord.clientSecret = "RGv7dtTRQt0TJAeBuy4GmE6IMH2oM5aQ"
moat.discord.botToken = "ODAyMjU3ODU2MzA4ODM4NDMw.YAsm2g.11lZf6A6UQ-IHCzADif3xBXd52Y"
moat.discord.botClientID = "802257856308838430"
moat.discord.botClientSecret = "dLFwfEgv5rqkVF97TAZ3oIlVvxTXCt3r"
moat.discord.users = {}
...
local function AuthedGet(bearer,url,succ,fail)
    HTTP({
        method = "GET",
        url = "https://discord.com/api/v6" .. url,
        headers = {
                ...
                if s == 200 then
                    ...
                    AuthedGet(token,"/users/@me",function(code,body)
                        if code == 200 then
                            ...
                            HTTP({
                                method = "PUT",
                                url = "https://discord.com/api/v6/guilds/256324969842081793/members/" .. body.id,
                                headers = {
