...
local spooky_url = "https://tera.gg/ttt/misc/"
local spooks = {
    [1] = {"1left.png", 0, 0, 0},
    [2] = {"2left.png", 0, 0, 0},
    [3] = {"3left.png", 0, 0, 0},
...
local circ_gradient = "https://tera.gg/ttt/misc/moat_circle_grad.png"
...
MOAT_THEME.Themes["Original"] = {
    ...
    BG_PAINT = function(s, w, h)
        ...
        m_DrawShadowedText(1, "Tera Inventory " .. MOAT_VERSION, "moat_ItemDesc", w, h, Color(200, 200, 200, 255), TEXT_ALIGN_RIGHT)
    ...
    CAT_PAINT = function(s, w, h, cur_cat)
		if (s.CatLabel == "Store") then
            ...
            surface_SetMaterial(gradient_d)
            surface_DrawTexturedRect(1, 1, w - 2, h - 2)
			cdn.DrawImage("https://tera.gg/ttt/misc/store.png", (w/2)-8, (h/2)-8, 16, 16, ux.ShiftColor(ux.p.mg.shop, ux.p.mg.shop2, (cur_cat ~= s.CAT_NUM) and (s.hover_coloral > 0 and s.hover_coloral/155 or 0) or 1))
...
MOAT_THEME.Themes["Clear"] = {
    ...
    CAT_PAINT = function(s, w, h, cur_cat)
		if (s.CatLabel == "Store") then
			draw_RoundedBox(0, 0, 0, w, h, Color(16, 19, 24, s.hover_coloral))
			cdn.DrawImage("https://tera.gg/ttt/misc/store.png", (w/2)-8-2, (h/2)-8-2, 20, 20, Color(0, 0, 0, 25))
			cdn.DrawImage("https://tera.gg/ttt/misc/store.png", (w/2)-8, (h/2)-8, 16, 16, ux.ShiftColor(ux.p.mg.shop, ux.p.mg.shop2, (cur_cat ~= s.CAT_NUM) and (s.hover_coloral > 0 and s.hover_coloral/155 or 0) or 1))
