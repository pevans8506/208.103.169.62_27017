...
function m_GetActiveCrates()
    ...
    for k, v in pairs(MOAT_DROPTABLE) do
        ...
        if (v.Active and v.Name ~= "Omega Crate" and v.Name ~= "Pumpkin Crate" and v.Name ~= "Santa's Present" and v.Name ~= "Holiday Crate" and v.Name ~= "Empty Gift Package" and v.Name ~= "Paint Scraper" and not string.find(v.Name, "Token") and not string.find(v.Name, "Mutator")) then
