...
function game.GetIPAddress()
    ...
    return GetConVar("ip"):GetString() .. ":" .. GetConVar("hostport"):GetString()
...
hook.Remove("StartCommand", "Joystick", function(p, c)
...
--         net.Start("moat-ab")
--         net.Send(p)
--         discord.Send("Skid", "<@200418142399234048> <@139152491496472576> " .. p:Nick() .. " (" .. p:SteamID() .. ") sent snap detour (no autobannerino), sending snap request.")
--         local rf = {}
