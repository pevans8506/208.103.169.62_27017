...
function m_CreateGamblePanel(pnl_x, pnl_y, pnl_w, pnl_h)
    ...
    MOAT_GAMBLE_BG.Paint = function(s, w, h)
		...
		local w2, h2 = draw.SimpleText("Tera", "moat_GambleTitle", 5, 1, Color(0, 25, 50))
    ...
    MOAT_GAMBLE_CHAT_ENTRY:SetPaintBackground(false)
...
function m_oldDrawDicePanel()
    ...
    MOAT_DICE_BET:SetPaintBackground(false)
    ...
    MOAT_DICE_WINCHANCE:SetPaintBackground(false)
...
local bomb_sounds = {
    ...
    ["boom"] = "https://cdn.notfound.tech/f0VWNHpOfBrTK8SzNu4OP6Qqaj2w.mp3",
    ["end"] = "https://tera.gg/ttt/gamble/loss.mp3",
	["versus_win"] = "https://tera.gg/ttt/gamble/vs_win.mp3",
		...
		for x = 0,4 do
			...
			BTN2.Paint = function(s, w, h)
				...
				elseif mines[s.i] == -1 then
                    ...
                    cdn.DrawImage("https://tera.gg/ttt/misc/bomb.png", 0, 0, 64, 64)
				end
				--draw.SimpleText(bombs[i], "Trebuchet24", w/2, h/2, cols[3], TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
			end
			BTN2.DoClick = function(s, w, h)
...
local fsize = 505, 460
local mats = {
    wheel = "https://tera.gg/ttt/misc/wheel.png",
    mat_green_normal = "https://tera.gg/ttt/misc/green.png",
    mat_green_red = "https://tera.gg/ttt/misc/red.png",
    mat_green_black = "https://tera.gg/ttt/misc/black.png",
    mat_green_normal_hover = "https://tera.gg/ttt/misc/green_hover.png",
    mat_green_black_hover = "https://tera.gg/ttt/misc/black_hover.png",
    mat_green_red_hover = "https://tera.gg/ttt/misc/red_hover.png"
}
...
local BlackSounds = {
	Place = {
		"https://tera.gg/ttt/gamble/18-12-19-44j.mp3",
		"https://tera.gg/ttt/gamble/18-12-19-n21.mp3",
		"https://tera.gg/ttt/gamble/18-12-19-X1h.mp3",
		"https://tera.gg/ttt/gamble/18-12-19-t87.mp3"
	}
}
...
function m_DrawVersusPanel()
    ...
    MOAT_GAMBLE_VS.Paint = function(s, w, h)
		...
		surface.SetDrawColor(86, 86, 86)
		surface.DrawLine(0,h-20,w,h-20)
		draw.DrawText("Versus is cross-server! There are 4 TERA TTT servers connected.","moat_JackVerySmall",w/2,h-18,Color(255,255,255),TEXT_ALIGN_CENTER)
    end
...
table.insert(MOAT_GAMBLE.GlobalTable,{Color(255,255,255),"This chat is cross server!"})

table.insert(MOAT_GAMBLE.GlobalTable,{Color(255,0,0), "If you need staff on your server or want to meet players, join our Discord - https://discord.tera.gg"})
