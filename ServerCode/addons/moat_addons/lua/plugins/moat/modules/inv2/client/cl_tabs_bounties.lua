...
hook.Add("TTTEndRound","BountyUpdate",function()
    timer.Simple(2,function()
        for k,v in pairs(update) do
            ...
            chat.AddText(Color(255, 255, 0),"[", Color(0, 255, 255),"TERA ", Color(255, 255, 0), "Bounties", Color(255, 255, 0), "] ", Color(255,255,255),"Your progress on ", chat_color_tiers[bounty_tbl[k].tier or 1],bounty_tbl[k].name,  Color(255,255,255), " has increased! [",Color(255,0,0),tostring(bounty_tbl[k].progress_cur), Color(255,255,255),"/",Color(0,255,0),tostring(bounty_tbl[k].progress_max) ,Color(255,255,255),"]")
        end
    end)
end)
