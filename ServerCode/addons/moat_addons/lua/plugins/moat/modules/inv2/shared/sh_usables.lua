...
MOAT_ITEM_CHECK[1] = {function(i) return (i.item and equipables[i.item.Kind:lower()]) or (i.Kind and equipables[i.Kind:lower()]) end, "Item must be equippable!"}

MOAT_ITEM_CHECK[2] = {function(i) return (((i.Rarity and i.Rarity <= 7) or (i.item and i.item.Rarity and i.item.Rarity <= 7)) and (i.Talents or i.t or (i.item and i.item.Talents))) end, "Item must be Cosmic with talents!"}

MOAT_ITEM_CHECK[3] = {function(i) return (((i.Rarity and i.Rarity <= 6) or (i.item and i.item.Rarity and i.item.Rarity <= 6)) and (i.Talents or i.t or (i.item and i.item.Talents))) end, "Item must be Ascended with talents!"}

MOAT_ITEM_CHECK[4] = {function(i) return (((i.Rarity and i.Rarity <= 5) or (i.item and i.item.Rarity and i.item.Rarity <= 5)) and (i.Talents or i.t or (i.item and i.item.Talents))) end, "Item must be High-End with talents!"}

MOAT_ITEM_CHECK[5] = {function(i) return (((i.Rarity and i.Rarity <= 9) or (i.item and i.item.Rarity and i.item.Rarity <= 9)) and (i.Talents or i.t or (i.item and i.item.Talents))) end, "Item must be Planetary with talents!"}

MOAT_ITEM_CHECK[6] = {function(i) return (((i.Rarity and i.Rarity <= 7) or (i.item and i.item.Rarity and i.item.Rarity <= 7)) and (i.Stats or (i.item and i.item.Stats))) end, "Item must be Cosmic with stats!"}

MOAT_ITEM_CHECK[7] = {function(i) return (((i.Rarity and i.Rarity <= 6) or (i.item and i.item.Rarity and i.item.Rarity <= 6)) and (i.Stats or (i.item and i.item.Stats))) end, "Item must be Ascended with stats!"}

MOAT_ITEM_CHECK[8] = {function(i) return (((i.Rarity and i.Rarity <= 5) or (i.item and i.item.Rarity and i.item.Rarity <= 5)) and (i.Stats or (i.item and i.item.Stats))) end, "Item must be High-End with stats!"}

MOAT_ITEM_CHECK[9] = {function(i) return (((i.Rarity and i.Rarity <= 9) or (i.item and i.item.Rarity and i.item.Rarity <= 9)) and (i.Stats or (i.item and i.item.Stats))) end, "Item must be Planetary with stats!"}
...
MOAT_ITEM_CHECK[13] = {function(i) return i.u ~= 7820 and i.u ~= 7821 end, "You can't wrap gift packages, sorry."}

MOAT_ITEM_CHECK[14] = {function(i) return i.p3 ~= nil end, "Item must have a skin!"}

MOAT_ITEM_CHECK[15] = {function(i) return i.p3 ~= nil or i.p2 ~= nil or i.p ~= nil end, "Item must have a skin/paint/tint!"}
