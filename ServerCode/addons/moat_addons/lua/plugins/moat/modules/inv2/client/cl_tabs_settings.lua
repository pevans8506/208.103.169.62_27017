local moat_convars = {
    ...
    ["moat_screenshake"] = 0,
    ["moat_deconhighends"] = 0,
    ["tera_doubleclickopencrate"] = 0,
    ["moat_disablesway"] = 0,
}
...
moat_Settings.Options = {
    {
        "General", {
            "Disable Screen Shaking", {"Multi"},
            "moat_screenshake"
        },
        -- {"Safe Messaging", {'Multi'}, 'moat_safety'},
        {
            "End Round Music", {"Multi"},
            "moat_music"
        },
        {
            "End Round Music Volume", {"Slider", 0, 1},
            "moat_music_volume"
        },
        {
            "FOV (75 to 110)", {"Slider", 0, 1},
            "moat_clfov"
        },
        {
            "Disable MOTD on Join", {"Multi"},
            "moat_disable_motd"
        },
        {
            "Invert Map [BETA]", {"Multi"},
            "moat_map_invert"
        },
        {
            "Disable Multicore Rendering (Might Fix Crashes)", {"Multi"},
            "moat_multicore"
        },
        {
            "Enable Hitmarkers", {"Multi"},
            "moat_hitmarkers"
        },
        {
            "Enable Damage Numbers", {"Multi"},
            "moat_damage_numbers"
        },
        {
            "Developer Mode", {"Multi"},
            "moat_developer_mode"
        }
    },
    {
        "Gameplay", {
            "Headshot Sound", {"Multi"},
            "moat_headshot_sounds"
        },
        {
            "Custom Headshot Sound", {"MultiText", "Eagle Aim", "Eagle Kill", "Eagle Clack", "Arcade Tap", "Arcade Headshot", "Arcade Kill", "Arcade Missed", "FPS Hitmarker", "FPS Headshot", "Rusty Aim"},
            "moat_headshot_sound"
        },
        {
            "Automatically Bunny-hop", {"Multi"},
            "moat_bunny_hop"
        },
        {
            "Outline Effect (FPS IMPACT)", {"MultiText", "Halos", "Chams", "Off"},
            "moat_OutlineTBuddies"
        },
        {
            "Enable Shadows (FPS IMPACT)", {"Multi"},
            "moat_EnableShadows"
        },
        {
            "Inventory Cosmetics Visible", {"Multi"},
            "moat_EnableCosmetics"
        },
        {
            "Inventory Effects Visible", {"Multi"},
            "moat_EnableEffects"
        },
        {
            "Inventory Effects Halos Visible (FPS IMPACT)", {"Multi"},
            "moat_EnableEffectHalos"
        },
        {
            "Flip Weapon View Models", {"Multi"},
            "moat_ViewModelFlip"
        },
        {
            "Disable 3D Skybox (Can Increase FPS)", {"Multi"},
            "moat_skybox"
        },
        {
            "Display Item Stats when Inspecting Weapons", {"Multi"},
            "moat_inspect_stats"
        },
        {
            "Disable Weapon Sway", {"Multi"},
            "moat_disablesway"
        },
    },
    {
        "HUD", {
            "Revert to Default HUD", {"Multi"},
            "moat_DisableCustomHUD"
        },
        {
            "Show Weapon Stats on Spawn", {"Multi"},
            "moat_showstats_spawn"
        },
        {
            "Show Weapon Stats on Pickup", {"Multi"},
            "moat_showstats_pickup"
        },
        {
            "Enable Damage Numbers", {"Multi"},
            "moat_damage_numbers"
        ...
        {
            "Show Killer info card on Death", {"Multi"},
            "moat_enable_deathcard"
        },
        {
            "Enable Custom Red Screen when Damaged", {"Multi"},
            "moat_red_screen"
        },
        {
            "Display Numbers for Ping on Scoreboard", {"Multi"},
            "moat_scoreboard_ping"
        },
        {
            "Enable Status Effect Notifications", {"Multi"},
            "moat_enable_effects"
        }
    },
    {
        "Inventory", {
            "Automatically Decline All Trade Requests", {"Multi"},
            "moat_autodecline"
        },
        {
            "Decline Trade Requests if Round is Active", {"Multi"},
            "moat_autodecline_active"
        },
        {
            "Automaticallly Rotate Model in Loadout", {"Multi"},
            "moat_autorotate_model"
        },
        {
            "Deconstruct Speed Multiplier", {"MultiText", "1", "3", "5", "10", "15", "20", "25", "100"},
            "moat_deconstruct_speed_multi"
        },
        {
            "Inventory Theme", {"MultiText", "Original", "Dark", "Light", "Blur", "Clear", "Alpha"},
            "moat_Theme"
        },
        {
            "Instantly Open Crates on Open", {"Multi"},
            "moat_fast_open"
        },
        {
            "Enable UI Sound Effects", {"Multi"},
            "moat_ui_sounds"
        },
        {
            "Enable Continuous Scrolling", {"Multi"},
            "moat_continue_scrolling"
        },
        {
            "Enable Custom Model Preview when Using Crates", {"Multi"},
            "moat_model_preview"
        },
        {
            "Disable Lighting in Inventory Model Preview", {"Multi"},
            "moat_inventory_lighting"
        },
        {
            "Double Click to Instantly Open Crates", {"Multi"},
            "tera_doubleclickopencrate"
        },
    },
    -- {"Holiday Inventory Theme", {"Multi"}, "moat_holiday_theme_2020"} -- {"Inventory Model Smoke", {"Multi"}, "moat_model_smoke"}, -- {"Spring Inventory Theme", {"Multi"}, "moat_spring_theme"}
    {
        "Item Drops", {
            "Disable Rare Item Warnings", {"Multi"},
            "moat_disable_rare_warnings"
        },
        {
            "Drop Cosmetic Items from End Round Drops", {"Multi"},
            "moat_dropcosmetics"
        },
        {
            "Drop Paint/Tint from End Round Drops", {"Multi"},
            "moat_droppaint"
        },
        {
            "Automatically Desconstruct Items after Obtained", {"Multi"},
            "moat_auto_deconstruct"
        },
        {
            "Rarity of Items to Automatically Deconstruct", {"MultiText", "Worn", "Standard", "Specialized", "Superior", "High-End", "Ascended"},
            "moat_auto_deconstruct_rarity"
        },
        {
            "Decon High End Items", {"Multi"},
            "moat_deconhighends"
        },
        {
            "Auto-Deconstruct filter Primaries", {"Multi"},
            "moat_auto_deconstruct_primary"
        },
        {
            "Auto-Deconstruct filter Secondaries", {"Multi"},
            "moat_auto_deconstruct_secondary"
        },
        {
            "Auto-Deconstruct filter Melees", {"Multi"},
            "moat_auto_deconstruct_melee"
        },
        {
            "Auto-Deconstruct filter Power-Ups", {"Multi"},
            "moat_auto_deconstruct_powerup"
        },
        {
            "Auto-Deconstruct filter Specials", {"Multi"},
            "moat_auto_deconstruct_special"
        },
        {
            "Auto-Deconstruct filter Usables", {"Multi"},
            "moat_auto_deconstruct_usable"
        },
        {
            "Auto-Deconstruct filter Head Cosmetics", {"Multi"},
            "moat_auto_deconstruct_head"
        },
        {
            "Auto-Deconstruct filter Mask Cosmetics", {"Multi"},
            "moat_auto_deconstruct_mask"
        },
        {
            "Auto-Deconstruct filter Body Cosmetics", {"Multi"},
            "moat_auto_deconstruct_body"
        },
        {
            "Auto-Deconstruct filter Effect Cosmetics", {"Multi"},
            "moat_auto_deconstruct_effect"
        },
        {
            "Auto-Deconstruct filter Model Cosmetics", {"Multi"},
            "moat_auto_deconstruct_model"
        }
    },
    {
        "Chat", {
            "Display Jackpot wins in chat", {"Multi"},
            "moat_chatjackpot"
        },
        {
            "Display Planetary drops in chat", {"Multi"},
            "moat_chatplanetary"
        },
        {
            "Display trades in chat", {"Multi"},
            "moat_showtrades"
        },
        {
            "Gangsta Speech Mode", {"Multi"},
            "moat_gangsta"
        },
        {
            "Hear TTS when available", {"Multi"},
            "moat_text_to_speech"
        },
        {
            "Minimum rarity required to see others obtaining items", {"MultiText", "Worn", "Standard", "Specialized", "Superior", "High-End", "Ascended"},
            "moat_chat_obtain_rarity"
        },
    },
    {
        "MGA", {
            "Low-End Mode (Disables Blur)", {"Multi"},
            "moat_mga_lowend"
        },
        {
            "Minimilist Player List", {"Multi"},
            "moat_mga_playerlist"
        },
        {
            "Entrance/Leaving Animation", {"Multi"},
            "moat_mga_animation"
        },
    },
    {
        "Dev", {
            "Allow more items to be skinned (Dangerous)", {"Multi"},
            "moat_pass_usable"
        },
        {
            "(TTTBeginRound) Enable Taskbar Flashing", {"Multi"},
            "moat_taskbar_flashing"
        }
    }
}
...
function m_RebuildSettingsPanel(num)
    ...
    if (not IsValid(M_SETTINGS_PNL_SCROLL)) then return end
