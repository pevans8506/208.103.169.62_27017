function mi.Log(str, err)
	if (not str) then MsgC(Color(0, 255, 0), "[TERA] " .. "----------------------------------\n") return end
	if (SERVER and err) then ServerLog("[TERA" .. ((err and " Failure!") or "") .. "] " .. str .. "\n") end
	MsgC(((err and Color(255, 0, 0)) or Color(0, 255, 0)), "[TERA" .. ((err and " Failure!") or "") .. "] " .. str .. "\n")
end
...
function mi.Print(str, b)
    MsgC(b and Color(255, 0, 0) or Color(255, 255, 0), "TERA | " .. str .. "\n")
end
