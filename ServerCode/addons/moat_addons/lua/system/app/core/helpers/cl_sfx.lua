...
function sfx.Cut()
    if (convar:GetInt() > 0) then
        cdn.PlayURL("https://tera.gg/ttt/misc/tttsounds/cut.ogg")
    end
end

function sfx.Tick()
    if (convar:GetInt() > 0) then
        cdn.PlayURL("https://tera.gg/ttt/misc/tttsounds/cut.ogg", .1)
    end
end

function sfx.Bells()
    if (convar:GetInt() > 0) then
        cdn.PlayURL"https://tera.gg/ttt/misc/tttsounds/message.ogg"
    end
end

function sfx.Subtract()
    if (convar:GetInt() > 0) then
        cdn.PlayURL"https://tera.gg/ttt/misc/tttsounds/click4.ogg"
    end
end

function sfx.Add()
    if (convar:GetInt() > 0) then
        cdn.PlayURL"https://tera.gg/ttt/misc/tttsounds/click5.ogg"
    end
end

function sfx.Max()
    if (convar:GetInt() > 0) then
        cdn.PlayURL"https://tera.gg/ttt/misc/tttsounds/click6.ogg"
    end
end

function sfx.Agree()
    if (convar:GetInt() > 0) then
        cdn.PlayURL"https://tera.gg/ttt/misc/tttsounds/accept.mp3"
    end
end

function sfx.Decline()
    if (convar:GetInt() > 0) then
        cdn.PlayURL"https://tera.gg/ttt/misc/tttsounds/decline.wav"
    end
end
...
function sfx.Click2()
    if (convar:GetInt() > 0) then
        cdn.PlayURL"https://tera.gg/ttt/misc/tttsounds/appear-online.ogg"
    end
end
