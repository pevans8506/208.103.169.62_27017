...
function PANEL:Init()
	...
	self.serverinfo:SetText((GetServerName() or "TERA TTT") .. " | 00 Rounds left")
	self.serverinfo:SetContentAlignment(7)
	self.serverinfo.Think = function(sf)
		local r, t = UntilMapChange()

		sf:SetText((GetServerName() or "TERA TTT") .. " | " .. r .. " Rounds Left")
		sf:SizeToContents()
	end
...
function PANEL:Paint()
   ...
   surface_DrawRect(0, 0, w, h)]]
	cdn.DrawImage("https://tera.gg/assets/img/bg-main.png", math.min((w/2) - (3840/2), 0), math.min((h/2) - (2160/2), 0), math.max(3840, h), math.max(2160, w), Color(255, 255, 255, 230))	
